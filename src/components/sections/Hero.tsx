	...
	return (
		<section id="hero" className="min-h-20 flex flex-1 flex-wrap items-center justify-center gap-12">
			<div className="hero w-full max-w-md">
				...
				{/* Container */}
				<div data-testid="container" className="relative group" onMouseLeave={handleCardHover}>
					{/* upper card */}
			...
			<div data-testid="resume-card" className={`${showResume ? 'flex' : 'hidden'} resume-card flex-col w-full max-w-xs`}			>
				<div className="card"	>
					<div className="py-1 px-4 flex flex-col gap-4 relative">
						...
						<h5 className="font-bold text-center textShadow">{t('resumeTitle')}</h5>
						<dl>
