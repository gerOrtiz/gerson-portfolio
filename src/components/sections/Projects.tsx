	...
	return (
		<section id="projects" className="px-0 lg:px-2 py-2 lg:py-4 flex flex-col gap-5">
			...
			<div className="w-full flex flex-col px-0 lg:px-6 gap-8">
				...
				>
					<div className="w-11/12 lg:w-1/2 flex justify-center justify-self-center shadow-blue-200 shadow-md rounded-3xl translate-y-1/2 lg:translate-y-1/3
					...
					<div className="card w-full lg:w-[60%] flex flex-col justify-self-center justify-center items-center py-9 px-6 min-h-80" >
						<div className="py-2 pt-6 lg:py-6 px-1 lg:px-10 mt-14 lg:mt-20 flex flex-col gap-4">
							...
							<div className="flex flex-1 flex-wrap w-full justify-center gap-2 lg:gap-4 lg:mt-2">
				...
				>
					<div className="card lg:w-[60%] flex flex-col justify-self-center items-center py-9 px-6 min-h-80 pb-20">
						<div className="py-2 pt-6 lg:py-6 px-1 lg:px-10 flex flex-col gap-4">
							<div>
								...
								<div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-0">
									...
									<div className="w-full lg:w-1/5 flex justify-start lg:justify-end">
										<a className="btn-base btn-primary btn-link items-center group" href="https://expo.dev/accounts/gerortiz/projects/frost-find/builds/e65e290b-cbf9-4427-8453-968e9bac792a" target="_blank">
											{t('download')}
											<MoveRight className="mt-0.5 w-4 h-4 transition-transform delay-75 group-hover:translate-x-1" />
										</a>
									</div>
							...
							<div className="flex flex-1 flex-wrap w-full justify-center items-center gap-2 lg:gap-4 lg:mt-2">
								{frostLogos.map((logo) => (
									<Image key={logo.name} src={logo.logo} alt={logo.name} height={50} className="h-10 w-auto lg:h-14" />
								))}
							</div>
					...
					<div className="w-11/12 lg:w-1/2 flex justify-self-center justify-evenly -translate-y-1/4 lg:-translate-y-[20%]">
						<div className="w-auto flex  shadow-blue-200 shadow-md rounded-3xl
					 hover:shadow-lg hover:shadow-blue-300 bg-white">
						...
						<div className="w-auto hidden lg:flex justify-evenly justify-self-center shadow-blue-200 shadow-md rounded-3xl
					 hover:shadow-lg hover:shadow-blue-300 bg-white">
							<Image src={loginScreen} alt="map-screen" className="w-full max-h-[250px] lg:max-h-[400px] rounded-3xl" loading="lazy" />
						</div>
						<div className="w-auto flex justify-evenly justify-self-center shadow-blue-200 shadow-md rounded-3xl
					 hover:shadow-lg hover:shadow-blue-300 bg-white">
